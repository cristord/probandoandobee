...
var MM = {
    ...
    _expandAddSiteForm: function() {
        ...
        $("#addsitebutton").css("display", "inline");
        $("#register, #cuenta").css("display", "inline");
        ...
        $("#register").on(MM.clickType, function () {
            window.open('http://www.faithory.com/courses/login/signup.php?','_system');
        });
        $('#username').focus();
        MM.util.showKeyboard();
    },
